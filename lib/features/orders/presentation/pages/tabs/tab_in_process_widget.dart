...
class TabInProcessWidget extends StatefulWidget {
  const TabInProcessWidget({super.key});

  @override
  State<TabInProcessWidget> createState() => _TabInProcessWidgetState();
}

class _TabInProcessWidgetState extends State<TabInProcessWidget> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) {
        _orderCubit.apiCallGetOrders(orderFilter: OrderStatusType.inProgress);
        return _orderCubit;
      },
